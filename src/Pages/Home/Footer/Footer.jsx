...
const Footer = () => {
  return (
    <section>
      <footer className=" sm:footer-horizontal bg-secondary-content text-base-content p-6 ">
        <div className="md:w-11/12 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Link
          ...
          >
            <div className="space-y-2">
              ...
              <p>
                I build responsive websites that enhance user experience and
