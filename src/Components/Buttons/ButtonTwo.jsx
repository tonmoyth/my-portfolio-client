...
const ButtonTwo = ({ level }) => {
  return (
    <button className="relative inline-flex items-center px-12 py-3 overflow-hidden text-lg font-medium text-primary border-2 border-accent rounded-full hover:text-white group hover:bg-accent">
